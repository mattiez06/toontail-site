...
const MEDIA = {
  ...
  videoAfter: "/media/toontail-alt2.mp4?v=8",
...
const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    subtitle: "Current Model Mercury V10 Verado 9 inch plate",
    status: "made_to_order",
    priceCents: 29999,
    compareAtCents: 49999,
    saleLabel: "Founders Run",
  ...
  },
  {
    ...
    subtitle: "2011 - 2017 Models with the 4.8 Gearcase 7 inch plate",
    status: "made_to_order",
    priceCents: 29999,
    compareAtCents: 49999,
    saleLabel: "Founders Run",
  ...
  },
   {
    ...
    subtitle: "2011 - Current Models with 4.9 Gearcase 7 inch plate",
    status: "made_to_order",
    priceCents: 29999,
    compareAtCents: 49999,
    saleLabel: "Founders Run",
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 md:py-18 grid md:grid-cols-2 gap-8 items-center">
        <div>
          ...
          <p className="mt-4 text-lg md:text-xl text-slate-700 max-w-xl">
            An efficient bolt-on jet that turns your tritoon or pontoon's wake into a clean, crowd-pleasing rooster tail.
          </p>
